...
@section('content')
<div class="site-wrapper" x-data="shop()">
    <!-- Navigation -->
                        ...
                        <div x-show="showResults && results.length > 0" 
                            ...
                            <template x-for="product in results" :key="product.id">
                                <a :href="product.url" class="flex items-center p-3 hover:bg-gray-50 border-b border-gray-100 last:border-0">
                                    <img x-show="product.image" :src="product.image" :alt="product.name" class="w-12 h-12 object-cover rounded mr-3">
                                    <div class="flex-1">
    ...
    <!-- Notification -->
    <div x-show="notification.show" :class="notification.type === 'success' ? 'bg-green-500' : 'bg-red-500'" class="fixed top-20 right-4 z-50 text-white px-6 py-3 rounded-lg shadow-lg max-w-sm">
        <div class="flex items-center">
