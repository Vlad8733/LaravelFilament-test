    ...
    <div class="footer-container">
        ...
        <div class="footer-top">
            <div class="footer-brand">
                <a href="{{ route('home') }}" class="footer-logo">
                    ...
                    <span>e-<em>Shop</em></span>
                </a>
                <p class="footer-desc">{{ __('footer.tagline') }}</p>
            </div>
        ...
        <div class="footer-grid">
            <div class="footer-col">
                ...
                <a href="{{ route('products.index') }}">{{ __('footer.categories') }}</a>
                <a href="{{ route('pages.about') }}">{{ __('footer.about_us') }}</a>
                <a href="{{ route('pages.contact') }}">{{ __('footer.contact') }}</a>
                <a href="{{ route('pages.faq') }}">{{ __('footer.faq') }}</a>
            </div>
            <div class="footer-col">
                <h4>{{ __('footer.customer_service') }}</h4>
                <a href="{{ route('orders.tracking.search') }}">{{ __('footer.order_tracking') }}</a>
                @auth
                    <a href="{{ route('refunds.index') }}">{{ __('footer.refunds') }}</a>
                    <a href="{{ route('tickets.index') }}">{{ __('footer.support') }}</a>
                @else
                    <a href="{{ route('login') }}">{{ __('footer.support') }}</a>
                @endauth
                <a href="{{ route('pages.faq') }}">{{ __('footer.help_center') }}</a>
            </div>
            <div class="footer-col">
                <h4>{{ __('footer.my_account') }}</h4>
                @auth
                    <a href="{{ route('profile.edit') }}">{{ __('footer.profile') }}</a>
                    <a href="{{ route('wishlist.index') }}">{{ __('footer.wishlist') }}</a>
                    <a href="{{ route('cart.index') }}">{{ __('footer.cart') }}</a>
                    <a href="{{ route('settings.index') }}">{{ __('footer.settings') }}</a>
                @else
                    <a href="{{ route('login') }}">{{ __('footer.sign_in') }}</a>
                    <a href="{{ route('register') }}">{{ __('footer.register') }}</a>
                @endauth
            </div>
            <div class="footer-col">
                ...
                <div class="contact-item">
                    ...
                    <span>123 Commerce Street, Riga</span>
                </div>
                <div class="contact-item">
                ...
                <div class="contact-item">
                    <svg viewBox="0 -960 960 960" fill="currentColor"><path d="M798-120q-125 0-247-54.5T329-329Q229-429 174.5-551T120-798q0-18 12-30t30-12h162q14 0 25 9.5t13 22.5l26 140q2 16-1 27t-11 19l-97 98q20 37 47.5 71.5T387-386q31 31 65 57.5t72 48.5l94-94q9-9 23.5-13.5T670-390l138 28q14 4 23 14.5t9 23.5v162q0 18-12 30t-30 12Z"/></svg>
        ...
        <div class="footer-bottom">
            <p>&copy; {{ date('Y') }} e-Shop. {{ __('footer.all_rights') }}</p>
