    ...
    <nav id="site-nav">
        <div class="nav-wrap">
            ...
            <div class="nav-actions">
                ...
                <a href="{{ route('checkout.show') }}" class="px-4 py-2 rounded-lg text-center font-medium transition-colors flex-none whitespace-nowrap" style="background: var(--accent); color: #071017;">
                    Proceed to Checkout
                </a>
