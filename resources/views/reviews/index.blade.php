    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="reviews-subtitle">Manage your product reviews</p>
            </div>
        </div>
        ...
        @if($reviews->isEmpty())
            <div class="reviews-card">
                <div class="reviews-empty">
                    ...
                    <p class="reviews-empty-text">After receiving your orders, you can leave reviews for the products.</p>
                </div>
            </div>
        @else
                    ...
                    <a href="{{ route('reviews.show', $review) }}" class="reviews-item">
                        <div class="reviews-item-header">
                            ...
                            <div class="reviews-item-info">
                                ...
                                <div class="reviews-item-order">Order #{{ $review->order->order_number }}</div>
                            </div>
                        ...
                        <div class="reviews-item-meta">
                            ...
                            <span class="reviews-item-date">{{ $review->created_at->format('M d, Y') }}</span>
                        </div>
